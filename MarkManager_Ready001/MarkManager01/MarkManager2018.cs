...
//using System.Windows.Forms.DataVisualization.Charting; import function..?!

namespace MarkManager01
{
    public partial class MarkManager2018 : Form //right click form to VIEW DESIGNER to open form2
    {
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            label15.Text = "Welcome to Mark Manager";
        }
        ...
        private void button1_Click(object sender, EventArgs e) // Typing validation /insert data to gridview view/error area color
        {


            if (textBox1.Text == "") //validation
            {
                textBox1.BackColor = Color.LightPink;// show error area color
        ...
        private void button6_Click(object sender, EventArgs e)                      //counting grades from the box
        {
            ...
            for (int i = Display.Items.Count -1; i >= 0; i++)
            {
                ...
                else if  (Display.Items[i].ToString().Contains("B"))
                {
                    Display.SetSelected(i, true);
                    chart1.Series["Grade"].Points.AddXY("B", i+1);
                     break;
                } 
                */
           ...
           /* for (int i = 0; i < inputlength; i++)
            {
                this.chart1.Series["Grade"].Points.AddXY("A", i);
            }
            this.chart1.Series["Grade"].Points.AddXY("A", i);
            this.chart1.Series["Grade"].Points.AddXY("B", 3);
            this.chart1.Series["Grade"].Points.AddXY("C", 2); */
           
        }

        private void button11_Click(object sender, EventArgs e) //exit button and exit dialog
        {
        ...
        private void button2_Click(object sender, EventArgs e) //calculate results using array/ validation
        {
            ...
            {
                textBox6.BackColor = Color.LightPink; // show error area color
            ...
            {
                textBox5.BackColor = Color.LightPink;
                MessageBox.Show("FinalExam score is required", "Validation Error");
                return;
            }
        ...
        private void button4_Click(object sender, EventArgs e) //clear details 
        {
            textBox1.Clear();
            textBox2.Clear();
            textBox3.Clear();
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            try
            {
                dataGridView1.ClipboardCopyMode = DataGridViewClipboardCopyMode.EnableAlwaysIncludeHeaderText;  //export file
                                                                                                                // Select all the cells
                dataGridView1.SelectAll();
                // Copy selected cells to DataObject
                DataObject dataObject = dataGridView1.GetClipboardContent();
                File.WriteAllText(@"C:\Users\bruno\Desktop\LMU\EXPORT.csv", dataObject.GetText(TextDataFormat.CommaSeparatedValue));
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                MessageBox.Show("please selecet a row NOT a collums");
            }
            catch (Exception ex)
            {

                MessageBox.Show("fucucucu please selecet a row NOT a collums");
            }
        }
